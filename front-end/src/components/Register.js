      ...
      <header className="App-header">
        ...
        <Form>
          ...
          <FormGroup tag="fieldset">
            ...
            <FormGroup check>
              <Label check>
                <Input type="radio" name="radio1" /> I am 18 years of age or
                older
              </Label>
            </FormGroup>
            <FormGroup check>
              <Label check>
                <Input type="radio" name="radio1" /> I am under 18 years of age
              </Label>
            </FormGroup>
          </FormGroup>
          <FormGroup check>
            <Label check>
              <Input type="checkbox" /> I have read all terms and conditions.
            </Label>
          </FormGroup>
